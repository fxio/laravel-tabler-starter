    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
                <div class="btn-list">
                    <a href="https://github.com/fxio/laravel-tabler-starter" class="btn" target="_blank" rel="noreferrer">
            ...
            <div class="nav-item">
                <div class="d-flex">
                    <a href="{{ route('login') }}" class="nav-link link-primary">Login</a>
                    <a href="{{ route('register') }}" class="nav-link link-primary">Register</a>
                </div>
            </div>
        </div>
    </div>
